...
const sourceFiles = files.filter((f) => !f.includes(`${path.sep}scripts${path.sep}`) && !f.includes(`${path.sep}supabase${path.sep}migrations${path.sep}`) && !f.includes(`${path.sep}.research${path.sep}`))

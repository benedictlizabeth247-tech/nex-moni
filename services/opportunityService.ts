...
export const getMockOpportunities = async (): Promise<Opportunity[]> => {
  ...
  return [
    ...
    },
    {
      ...
      isVerified: true,
      shortDescription: 'Create comprehensive developer guides for the latest Apedat SDK updates.',
      description: 'Help developers onboard into the Apedat ecosystem by writing clear, concise, and accurate technical documentation for our new payment APIs.',
      rewardAmount: 500000,
      rewardCurrency: 'NGN',
      category: 'Content',
      location: 'Nigeria',

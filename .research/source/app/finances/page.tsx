...
] as [string, string, string, string, [string, string][]][]).map(([firm, name, category, domain, holdings]) => ({ name, firm, category, logo: `https://www.google.com/s2/favicons?domain=${domain}&sz=128`, source: `https://${domain}`, holdings }))

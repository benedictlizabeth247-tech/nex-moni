...
function IconBox({icon}:{icon:React.ReactNode}){return <div className="grid h-9 w-9 place-items-center rounded-[13px] bg-[#E8F7F0] text-[#087F5B] dark:bg-[#20362E] dark:text-[#5BD19D]">{React.isValidElement<{size?: number; strokeWidth?: number}>(icon)?React.cloneElement(icon,{size:19,strokeWidth:2.1}):icon}</div>}
